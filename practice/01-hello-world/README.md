...
[Chapter 00](../../curriculum/00-getting-started/README.md) · [Practice index](../README.md) · [Learning path](../../README.md)
...
```bash
node practice/01-hello-world/hello.js
# or
npm run lesson:01
```
...
| `"Hello, world!"` | A **string literal**. JS allows three quote styles: `'…'`, `"…"`, and `` `…` `` (template literal — see [Fundamentals](../../curriculum/01-fundamentals/README.md)). | Java only allows `"…"` (and text blocks `"""…"""`). |
...
> a class — it’s a value. [Objects and arrays](../../curriculum/03-objects-and-arrays/README.md) goes deeper on this.
...
Now open [hello.js](hello.js), then try [exercises.js](exercises.js). Compare with [solutions.js](solutions.js) after your attempt, then return to [chapter 00](../../curriculum/00-getting-started/README.md).
