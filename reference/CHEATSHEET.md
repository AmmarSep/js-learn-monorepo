...
[Reference index](README.md) · [Hello-world lesson](../practice/01-hello-world/README.md)
...
| Run command | `javac Main.java && java Main` | `node practice/01-hello-world/hello.js` (from the repository root) |
